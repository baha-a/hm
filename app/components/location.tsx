    ...
    <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-20 lg:px-8">
      ...
      <div className="mt-16 lg:mt-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          <a href="https://maps.app.goo.gl/h76gkPCjhokxwnrp7" target="_blank">
      ...
      <div className="flex gap-6 justify-center items-center pt-20">
        <h3 className="font-bold">Folgen Sie uns</h3>
        <a href="https://www.facebook.com/profile.php?id=61552172319852" className="shadow-xl cursor-pointer rounded bg-blue-600 pl-1 opacity-70 dark:opacity-50 hover:opacity-100">
        ...
        <a href="https://www.instagram.com/dellbruckhaushaltsgerate/" className="shadow-xl cursor-pointer rounded bg-red-500 opacity-70 dark:opacity-50 px-0.5 hover:opacity-100">
        ...
        <a href="https://kleinanzeigen.de/s-bestandsliste.html?userId=134640071" className="shadow-xl cursor-pointer rounded bg-green-600 py-1 px-2.5 opacity-70 dark:opacity-50 hover:opacity-100">
